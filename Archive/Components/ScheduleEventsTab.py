...
class ScheduleEvents(QWidget):
    ...
    def setup_ui(self):
        ...
        schdrec_btn = QPushButton("Schedule Events")
        schdrec_btn.setStyleSheet(styles.button_style1)
        schdrec_btn.setFixedSize(150,25)

        configdur_btn = QPushButton("Configure Duration")
        configdur_btn.setStyleSheet(styles.button_style2)
        configdur_btn.setFixedSize(150,25)

        config_widget_layout.addWidget(configdur_btn)
        config_widget_layout.addWidget(schdrec_btn)
